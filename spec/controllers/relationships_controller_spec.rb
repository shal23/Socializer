...
describe RelationshipsController do
  ...
  let(:valid_attributes) { { "follower_id" => "1" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved relationship as @relationship" do
        ...
        post :create, {:relationship => { "follower_id" => "invalid value" }}, valid_session
        assigns(:relationship).should be_a_new(Relationship)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested relationship" do
        ...
        Relationship.any_instance.should_receive(:update_attributes).with({ "follower_id" => "1" })
        put :update, {:id => relationship.to_param, :relationship => { "follower_id" => "1" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the relationship as @relationship" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Relationship.any_instance.stub(:save).and_return(false)
        put :update, {:id => relationship.to_param, :relationship => { "follower_id" => "invalid value" }}, valid_session
        assigns(:relationship).should eq(relationship)
      end
